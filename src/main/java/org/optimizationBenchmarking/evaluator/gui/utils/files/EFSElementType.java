...
import org.optimizationBenchmarking.evaluator.gui.utils.Image;
...
public enum EFSElementType {
  ...
  /** an evaluation file */
  EVALUATION(true, "evaluation", //$NON-NLS-1$
  ...
  CONFIGURATION(true, "configuration", //$NON-NLS-1$
  ...
  static {
    ...
    EFSElementType.MAP.put(
        org.optimizationBenchmarking.evaluator.io.impl.edi.EDI.EDI_XML,
        EDI);

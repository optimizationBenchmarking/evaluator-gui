...
public final class SelectionAction extends HashObject {
  ...
  public final boolean equals(final Object o) {
    ...
    if (o instanceof SelectionAction) {
      ...
      return (Compare.equals(this.m_name, sel.m_name) && //
          Compare.equals(this.m_page, sel.m_page) && //
          Compare.equals(this.m_frame, sel.m_frame) && //
          Compare.equals(this.m_method, sel.m_method) && //
          Compare.equals(this.m_desc, sel.m_desc));
    }
    return false;
  }
